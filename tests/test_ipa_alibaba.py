...
"""img_proof Alibaba provider unit tests."""
...
class TestAlibabaProvider(object):
    """Test Alibaba provider class."""
    ...
    def test_exception_required_args(self):
        ...
        msg = 'Region is required to connect to Alibaba.'

        # Test region required
        with pytest.raises(AlibabaCloudException) as error:
            AlibabaCloud(**self.kwargs)

        assert str(error.value) == msg

        self.kwargs['config'] = 'tests/data/config'

    @patch('img_proof.ipa_alibaba.AcsClient')
    def test_bad_connection(self, mock_client):
        ...
        provider = AlibabaCloud(**self.kwargs)
    ...
    @patch.object(AlibabaCloud, '_connect')
    ...
    @patch.object(AlibabaCloud, '_get_instance')
    ...
    @patch.object(AlibabaCloud, '_get_instance_state')
    def test_is_instance_running(self, mock_get_instance_state):
        """Test alibaba provider is instance runnning method."""
    ...
    @patch.object(AlibabaCloud, '_wait_on_instance')
    @patch.object(AlibabaCloud, '_connect')
    def test_launch_instance(self, mock_connect, mock_wait_on_instance):
        """Test alibaba provider launch instance method."""
        response = json.dumps({
            'InstanceIdSets': {
    ...
    def test_set_image_id(self, mock_get_instance):
        """Test alibaba provider set image id method."""
    ...
    def test_start_instance(
        ...
        """Test alibaba start instance method."""
        client = MagicMock()
        mock_connect.return_value = client
    ...
    def test_stop_instance(
        ...
        """Test alibaba stop instance method."""
        client = MagicMock()
        mock_connect.return_value = client
    ...
    def test_terminate_instance(self, mock_connect):
        """Test alibaba terminate instance method."""
        client = MagicMock()
        mock_connect.return_value = client
    ...
    def test_get_console_log(self, mock_connect):
        """Test alibaba get console log method."""
        response = json.dumps({
